...
CREATE INDEX idx_orders_update_date ON orders (update_date);
...
(
    ...
    delivery_time_min         DATE COMMENT 'Минимальный срок доставки',
    delivery_time_max         DATE COMMENT 'Максимальный срок доставки',
    weight                    DOUBLE NOT NULL COMMENT 'весупаковки',
...
CREATE INDEX idx_orders_article_orders_id_article_id ON orders_article (orders_id, article_id);